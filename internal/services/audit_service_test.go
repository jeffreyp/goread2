...
func (m *mockDBAudit) UpdateUserSubscription(int, string, string, time.Time, time.Time) error {
	return nil
}
...
func (m *mockDBAudit) GetUserFeedArticlesPaginated(int, int, int, string, bool) (*database.ArticlePaginationResult, error) {
	return &database.ArticlePaginationResult{}, nil
}
...
func (m *mockDBAudit) GetTotalArticleCount(int) (int, error)         { return 0, nil }
...
func (m *mockDBAudit) FilterExistingArticleURLs(int, []string) (map[string]bool, error) {
	return map[string]bool{}, nil
}
func (m *mockDBAudit) UpdateFeedAfterRefresh(int, time.Time, time.Time, int, time.Time, string, string) error {
	return nil
}
