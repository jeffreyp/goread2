...
func (m *mockDBAdminHandler) GetUserFeedCounts(int) (map[int]database.FeedCounts, error) {
	return nil, nil
}
func (m *mockDBAdminHandler) CleanupOrphanedUserArticles(int) (int, error) { return 0, nil }
