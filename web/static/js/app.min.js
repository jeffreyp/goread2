class GoReadApp {
    ...
    async loadFeedsOptimized() {
        try {
            ...
            // Remove existing non-special feeds and add loading indicator
    ...
    async loadFeedsOptimizedWithCacheBust() {
        try {
            ...
            console.error('Failed to load feeds with cache bust:', error);
            this.showError('Failed to load feeds: ' + error.message);
        }
    }
    ...
    renderFeeds() {
        ...
        // Remove existing feed items and loading div (preserve special items)
    ...
    async toggleCurrentArticleRead() {
        ...
        try {
            ...
            const countChange = newReadState ? -1 : 1;
            if (article.feed_id) {
